...
export function defineSmartComponent(definition) {
  if (!definition?.type) fail("smart component definition", "missing type");
  if (!definition.kind) fail(definition.type, "missing kind");
  ...
  if (typeof definition.customUi?.mountSmartComponentUi !== "function") fail(definition.type, "missing generic smart component UI mountSmartComponentUi(args)");
