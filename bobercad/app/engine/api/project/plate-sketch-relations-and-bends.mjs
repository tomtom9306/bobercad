import { cleanVec2Loop, finiteNonNegativeNumber, finiteNumber, finitePositiveNumber, finiteVec3, v } from "../../core/math.mjs";
...
function requiredIdPair(value, label) {
...
function sketchDimensionMode(value, label) {
...
function sketchSource(options, id, label) {
