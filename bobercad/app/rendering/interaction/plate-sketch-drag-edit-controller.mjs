...
import { snapPointOverlay } from "../scene/authoring/snap-overlays.mjs?v=plate-face-snap-2";
...
function requiredPoint2(value, label = "sketch point") {
