...
4. `webgl-viewer-runtime.mjs` draws the resulting lines, labels, callouts, hover, and edit controls.
...
- Put shared math and annotation builders in `dimension-geometry-and-label-context.mjs`; keep handler files focused on one dimension concept.
