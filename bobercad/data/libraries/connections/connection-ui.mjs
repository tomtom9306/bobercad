import { clone, optionalPath, requiredPath, setPath } from "../../../app/engine/modules/connections/connection-schema.mjs";
...
function normalizedSpacingList(parameters, derive = {}, existing = []) {
...
function parameterValue(definition, parameters, path, api) {
...
function conditionDependsOn(condition, path) {
